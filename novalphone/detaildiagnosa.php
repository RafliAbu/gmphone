    ...
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="index.html" class="flex items-center">
                ...
                <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">GM Phone <span class="bg-gray-100 text-gray-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300">Noval</span></span>
            </a>
    ...
    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Berikut adalah hasil diagnosa dari kerusakan smartphone kamu</p>
      <form method="POST">
        ...
        <div class="form-group"  method="POST">
          ...
          <button> <a target="_Blank" href="cetak.php" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">CETAK</a></button>
         </>
</div>
    </div>
  </div>
