...
<html lang="en">
  <head>
    ...
    <title>Dasbor Admin | GM Phone</title>
...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#"><b>GM Phone Admin</b></a>
  ...
  <caption>Tabel histori customer</caption>              
   <thead>
      ...
      $id=0;
          ...
          <button> <a target="_Blank" href="acetak.php" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-black bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">CETAK</a></button>
         </>
</div>
